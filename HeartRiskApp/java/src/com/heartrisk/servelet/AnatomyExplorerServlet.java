...
@WebServlet({"/tools/anatomy"})
public class AnatomyExplorerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws ServletException, IOException {
        paramHttpServletRequest.getRequestDispatcher("/WEB-INF/views/tools/anatomy.jsp")
