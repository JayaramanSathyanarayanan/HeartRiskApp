...
@WebServlet({"/tools/heart-age"})
public class HeartAgeServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest paramHttpServletRequest, HttpServletResponse paramHttpServletResponse) throws ServletException, IOException {
        paramHttpServletRequest.getRequestDispatcher("/WEB-INF/views/tools/heart-age.jsp")
